...
internal class MoveableStatisticPanel : MoveableSemiTransparentPanel
{
    ...
    internal override void Draw(Graphics g)
    {
        ...
        string debug =
            $"KEYS: [Q]uick learn | [D]isable inheritance | [M]utate | [F]ormula dump\n\n" +
            $"Epoch/generation: {LearningAndRaceManager.s_generation}\n" +
            $"Quick Learn: {(LearningAndRaceManager.SilentLearning ? "YES" : "NO")}\n" +
