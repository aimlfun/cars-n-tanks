...
namespace AICarTrack.World.UX.VehicleRenderers
{
    internal static class GoKartTelemetry
    {
        ...
        private static void DrawCOGandShiftOfCOG(CarUsingRealPhysics data, Graphics g, int y, float carHeight, int centreX, double cog)
        {
            ...
            double cogShift = MathUtils.Clamp(y + frontAxleRatio * carHeight, y, y + carHeight) * 0.5f;
        ...
        private static void DrawSidewaysSlip(CarUsingRealPhysics data, Graphics g, int centreX)
        {
            ...
            g.DrawLine(pArrow, (int)(centreX), (int)(tyreFrontRight.Y - 40), (int)((centreX) + xr), (int)(tyreFrontRight.Y + yr) - 40);
            ...
            g.DrawLine(pArrow, (int)(centreX), (int)(tyreRearRight.Y + 30), (int)((centreX) + xr), (int)(tyreRearRight.Y + yr) + 30);
        }
