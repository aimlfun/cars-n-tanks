...
internal class VehicleInputState
{
    ...
    /// Amount to break 0..1 from the neural network.
    /// </summary>
    internal double Brake { get => brake; set => brake = value.Clamp(0, 1); }

    /// <summary>
    /// Left throttle (tank) / accelerator for car.
    /// </summary>
    ...
    /// </summary>
    internal double Throttle1 { get => throttle1; set => throttle1 = value.Clamp(0, 1.5); }

    /// <summary>
    /// Throttle amount 0..1.5, excludes <0. 2nd throttle is to support tank tracks (left vs. right)
    /// </summary>
    internal double Throttle2 { get => throttle2; set => throttle2 = value.Clamp(0, 1.5); }
