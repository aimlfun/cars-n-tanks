...
/// (instead of PointF which uses X & Y)
/// </summary>
...
/// I used https://github.com/spacejack/carphysics2d as a template. Thanks @spacejack.
/// This was combined with https://asawicki.info/Mirror/Car%20Physics%20for%20Games/Car%20Physics%20for%20Games.html
/// </summary>
internal class CarUsingRealPhysics : Vehicle
{
    ...
    /// <summary>
    /// Sideways friction on the front tyres.
    /// </summary>
    internal double frictionForceFrontLocalCarCoordsSideways;

    /// <summary>
    /// Sideways friction on the read tyres.
    /// </summary>
    ...
    /// Delta T in seconds
    /// </summary>
    internal double dt = 30F / 1000F;  // seconds.
    ...
    internal override void ApplyPhysics(VehicleInputState carInputState)
    {
        ...
        if (safeSteer) amountOfSteeringInput = ApplySafeSteer(amountOfSteeringInput);
    ...
    /// <summary>
    /// Calculate the friction the tyres are providing.
    /// </summary>
    private void CalculateFrictionFromTyres()
    {
        ...
        double tyreGripRear = Config.GripOfRearTyres * (1.0F - inputs.Ebrake * (1.0F - Config.gripWhenWheelIsLocked / 100)); // reduce rear grip when ebrake is on
    ...
    /// <summary>
    /// Compute how much the car is sliding sideways.
    /// </summary>
